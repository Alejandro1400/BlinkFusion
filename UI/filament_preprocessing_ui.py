...
from Data_access.file_explorer import aggregate_metadata_info, extract_gain_value, find_items, find_valid_folders, get_open_laser_intensity, parse_metadata_input, process_tiff_metadata, read_tiff_metadata
...
def load_filament_metadata(soac_folder):
    ...
    # check only the first 10 folders
    valid_folders = valid_folders[:50]
    ...
    for folder in valid_folders:
        ...
        metadata = read_tiff_metadata(tif_file, root_tag = 'custom-prop')
